...
export const tr: TranslationKeys = {
  ...
  sendTestNotificationDescription: 'Cihazınızda gerçek bildirimin önizlemesini görün',
  notificationsDisabledTitle: 'Bildirimler Kapalı',
  notificationsDisabledMessage: 'Test bildirimi göndermek için önce bildirimleri etkinleştirin.',
  preview: 'Önizleme',
  backgroundThemes: 'Arka Plan Temaları',
  accentColors: 'Vurgu Renkleri',
  defaultBackground: 'Varsayılan',
  warmGold: 'Sıcak Altın',
  calmBlue: 'Sakin Mavi',
  softGreen: 'Yumuşak Yeşil',
  lightPurple: 'Açık Mor',
  freshTeal: 'Taze Deniz Mavisi',
  gentleRose: 'Narin Gül',
  warmSunset: 'Sıcak Gün Batımı',
  coolOcean: 'Serin Okyanus',
  deepNight: 'Derin Gece',
  customImage: 'Özel Görsel',
  chooseFromGallery: 'Galeriden Seç',
  galleryPickerError: 'Görsel seçilirken bir hata oluştu, lütfen tekrar deneyin',
  quranKareem: 'Kur\'an-ı Kerim',
  lastRead: 'Son Okunan',
  ...
  pageTab: 'Sayfa',
  hizbTab: 'Hizb',
  playSurah: 'Sure Oynat',
  quranDescription: 'Kuran\'ı oku ve dinle',
  verses: 'Ayetler',
  ayah: 'Ayet',
  ayahNumber: 'Ayet Numarası',
  loadingVerses: 'Ayetler yükleniyor...',
  errorLoadingVerses: 'Ayetler yüklenirken hata',
  noVersesAvailable: 'Ayet mevcut değil',
  bismillah: 'Rahman ve Rahim olan Allah\'ın adıyla',
  meccan: 'Mekki',
  medinan: 'Medeni',
  reciteSurah: 'Sureyi Oku',
  stopRecitation: 'Tilaveti durdur',
  selectReciterTitle: 'Okuyucu Seç',
  juzNumber: 'Cüz',
  page: 'Sayfa',
  hizbNumber: 'Hizb',
  ayahs: 'ayet',
  ...
  kaaba: 'Kutsal Kabe',
  facingQibla: 'Kıbleye Yönelmiş',
  alignToQibla: 'Telefonunuzu okla hizalayın',
  compassAccuracy: 'Pusula Doğruluğu',
  accuracyLow: 'Düşük',
  accuracyMedium: 'İyi',
  accuracyHigh: 'Mükemmel',
  accuracyUnavailable: 'Kullanılamıyor',
  calibrateCompass: 'Pusola Kalibrasyonu',
  calibrateCompassInstruction: 'Pusolayı kalibre etmek için telefonunuzu 8 şeklinde hareket ettirin',
  calibrateCompassTitle: 'Pusola kalibrasyon gerektiriyor',
  calibrateStep1: 'Telefonunuzu dik tutun ve metal eşyalardan uzaklaştırın',
  calibrateStep2: '8 şeklinde yavaşça hareket ettirin',
  calibrateStep3: 'Doğruluk iyileşene kadar tekrarlayın',
  magneticFieldStrength: 'Manyetik alan',
  recalibrate: 'Yeniden Kalibre Et',
  sensorStatus: 'Sensör Durumu',
  locationNeeded: 'Konum Gerekli',
  locationPermissionDenied: 'Konum izni reddedildi. Kıble yönünü bulmak için Ayarlar\'dan etkinleştirin.',
  compassUnavailable: 'Bu cihazda pusula mevcut değil',
  enableLocation: 'Konumu Etkinleştir',
  findingQibla: 'Kıble yönü aranıyor...',
  qiblaInfoTitle: 'Kıbleye Yönelmenin Fazileti',
  qiblaInfoText: 'Kıbleye yönelmek namazın geçerlilik şartlarından biridir. Bu, Müslümanların Mekke\'deki Allah\'ın Kutsal Evi\'ne yönelme yönüdür.',
  ...
  prayerTimesError: 'Namaz vakitleri yüklenemedi',
  // ── Pusula özelleştirme ──
  compassStyle: 'Pusula Stili',
  compassAppearance: 'Pusula Görünümü',
  dialStyle: 'Kadran Stili',
  arrowColor: 'Ok Rengi',
  compassThemeClassic: 'Klasik',
  compassThemeMosaic: 'Mozaik',
  compassThemeOttoman: 'Osmanlı',
  compassThemeMoroccan: 'Fas',
  compassThemeMinimal: 'Minimal',
  compassThemePersian: 'Pers',
  arrowGold: 'Altın',
  arrowEmerald: 'Zümrüt',
  arrowCrimson: 'Kızıl',
  arrowTurquoise: 'Turkuaz',
  arrowSilver: 'Gümüş',
  arrowIndigo: 'Çivit',
  selectCompassStyle: 'Pusula Stili Seç',
  compassStyleDescription: 'Kıble pusulanız için İslami görsel stil seçin',
firebaseNotConfigured: 'Giriş hizmeti şu anda kullanılamıyor',
firebaseNotConfiguredShort: 'Firebase hizmeti yapılandırılmamış',
...
networkError: 'İnternete bağlanılamıyor, bağlantınızı kontrol edin',
...
forgotPasswordDescription: 'E-postanızı girin, size şifre sıfırlama bağlantısı gönderelim',
resetEmailSent: 'Şifre sıfırlama bağlantısı e-postanıza gönderildi',
resetRequestError: 'Sıfırlama bağlantısı gönderilirken bir hata oluştu',
emailMayBeRegistered: 'Bu e-posta kayıtlı değil, lütfen kontrol edin',
tooManyResetRequests: 'Çok fazla sıfırlama talebi, lütfen bekleyin',
returnToSignIn: 'Girişe Dön',
checkEmailForResetLink: 'Sıfırlama bağlantısı için e-postanızı kontrol edin',
verificationEmailSentTo: 'Doğrulama bağlantısı {{email}} adresine gönderildi',
verificationPending: 'E-posta henüz doğrulanmadı, lütfen e-postanızı kontrol edin',
verificationEmailResent: 'Doğrulama bağlantısı yeniden gönderildi',
clickVerificationLink: 'E-postanızdaki doğrulama bağlantısına tıklayın',
verifyEmailTitle: 'E-postanızı Doğrulayın',
resendVerification: 'Doğrulama Bağlantısını Yeniden Gönder',
resendingVerification: 'Yeniden gönderiliyor...',
checkingVerification: 'Kontrol ediliyor...',
verificationComplete: 'Doğrulandı, şimdi devam edin',
emailVerified: 'E-posta Doğrulandı',
logoutConfirm: 'Çıkış yapmak istediğinize emin misiniz?',
logoutError: 'Çıkış yaparken bir hata oluştu',
updateProfileError: 'Profil güncellenirken bir hata oluştu',
updatePasswordError: 'Şifre güncellenirken bir hata oluştu',
...
user: 'Kullanıcı',
noEmail: 'E-posta yok',
photoUploadedSuccessfully: 'Fotoğraf başarıyla yüklendi',
photoUploadError: 'Fotoğraf yüklenirken bir hata oluştu',
photoRemovedSuccessfully: 'Fotoğraf başarıyla kaldırıldı',
photoRemoveError: 'Fotoğraf kaldırılırken bir hata oluştu',
removePhoto: 'Fotoğrafı Kaldır',
removePhotoConfirm: 'Bu fotoğrafı kaldırmak istediğinize emin misiniz?',
changeProfilePhoto: 'Profil Fotoğrafını Değiştir',
takePhoto: 'Fotoğraf Çek',
cameraPermissionDenied: 'Kamera izni reddedildi',
imagePickerError: 'Resim seçilirken bir hata oluştu',
cameraError: 'Fotoğraf çekilirken bir hata oluştu',
...
contactSupportMessage: 'Bizimle e-posta yoluyla iletişime geçebilirsiniz',
shareAppMessage: 'Uygulamayı arkadaşlarınızla paylaşın',
rateAppMessage: 'Mağazada bizi değerlendirerek yardımcı olun',
preferences: 'Tercihler',
showTransliteration: 'Transkripsiyonu Göster',
showTranslation: 'Çeviriyi Göster',
accountInfo: 'Hesap Bilgileri',
accountCreationError: 'Hesap oluşturulurken bir hata oluştu',
emailAlreadyInUse: 'Bu e-posta zaten kullanımda',
weakPassword: 'Şifre zayıf, lütfen daha güçlü bir şifre seçin',
