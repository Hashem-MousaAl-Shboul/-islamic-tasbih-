...
export const en: TranslationKeys = {
  ...
  privacyInfoNoTracking: 'Advertising: We use Google AdMob to display non-personalized banner ads. AdMob may collect device identifiers and usage data for ad serving purposes. No personally identifiable information is shared with advertisers.',
  ...
  privacySharingText: 'We do not sell, trade, or share your personal data with any third parties. We use Google AdMob to display ads, which may use device identifiers for ad serving. You can opt out of personalized ads in your device settings. Your dhikr practice is personal and remains private to you.',
  ...
  sendTestNotificationDescription: 'Preview the actual notification on your device',
  notificationsDisabledTitle: 'Notifications Disabled',
  notificationsDisabledMessage: 'Enable notifications first to send a test notification.',
  preview: 'Preview',
  ...
  freshTeal: 'Fresh Teal',
  gentleRose: 'Gentle Rose',
  warmSunset: 'Warm Sunset',
  coolOcean: 'Cool Ocean',
  deepNight: 'Deep Night',
  customImage: 'Custom Image',
  chooseFromGallery: 'Choose from Gallery',
  galleryPickerError: 'An error occurred while selecting the image, please try again',
  quranKareem: 'The Noble Quran',
  lastRead: 'Last Read',
  ...
  quranDescription: 'Read and listen to the Quran',
  verses: 'Verses',
  ayah: 'Ayah',
  ...
  hizbNumber: 'Hizb',
  ayahs: 'ayahs',
  goToReader: 'Read Verses',
  repeatSurah: 'Repeat Surah',
  repeat: 'Repeat',
  audioNetworkError: 'Could not load recitation. Check your internet connection.',
  ...
  alignToQibla: 'Align your phone with the arrow',
  ...
  calibrateCompassInstruction: 'Move your phone in a figure-8 pattern to calibrate the compass',
  calibrateCompassTitle: 'Compass needs calibration',
  calibrateStep1: 'Hold your phone upright and away from metal objects',
  calibrateStep2: 'Move it in a slow figure-8 motion',
  calibrateStep3: 'Repeat until accuracy improves',
  magneticFieldStrength: 'Magnetic field',
  recalibrate: 'Recalibrate',
  sensorStatus: 'Sensor Status',
  locationNeeded: 'Location Required',
  locationPermissionDenied: 'Location permission denied. Enable it in Settings to find Qibla direction.',
  compassUnavailable: 'Compass not available on this device',
  enableLocation: 'Enable Location',
  findingQibla: 'Finding Qibla direction...',
  qiblaInfoTitle: 'Virtue of Facing Qibla',
  qiblaInfoText: 'Facing the Qibla is a condition for the validity of prayer. It is the direction Muslims face toward the Sacred House of Allah in Makkah, uniting all believers in prayer toward one point.',
  ...
  prayerTimesError: 'Could not load prayer times',
  // ── Compass style customization ──
  compassStyle: 'Compass Style',
  compassAppearance: 'Compass Appearance',
  dialStyle: 'Dial Style',
  arrowColor: 'Arrow Color',
  compassThemeClassic: 'Classic',
  compassThemeMosaic: 'Mosaic',
  compassThemeOttoman: 'Ottoman',
  compassThemeMoroccan: 'Moroccan',
  compassThemeMinimal: 'Minimal',
  compassThemePersian: 'Persian',
  arrowGold: 'Gold',
  arrowEmerald: 'Emerald',
  arrowCrimson: 'Crimson',
  arrowTurquoise: 'Turquoise',
  arrowSilver: 'Silver',
  arrowIndigo: 'Indigo',
  selectCompassStyle: 'Select Compass Style',
  compassStyleDescription: 'Choose an Islamic visual style for your Qibla compass',
firebaseNotConfigured: 'Login service is currently unavailable',
firebaseNotConfiguredShort: 'Firebase service is not configured',
...
networkError: 'Unable to connect to the internet, check your connection',
...
emailMayBeRegistered: 'This email is not registered, please check',
tooManyResetRequests: 'Too many reset requests, please wait',
returnToSignIn: 'Return to Sign In',
checkEmailForResetLink: 'Check your email for the reset link',
verificationEmailSentTo: 'Verification link sent to {{email}}',
verificationPending: 'Email not verified yet, please check your email',
verificationEmailResent: 'Verification link resent successfully',
...
photoRemoveError: 'An error occurred while removing photo',
removePhoto: 'Remove Photo',
removePhotoConfirm: 'Are you sure you want to remove this photo?',
changeProfilePhoto: 'Change Profile Photo',
takePhoto: 'Take Photo',
cameraPermissionDenied: 'Camera permission denied',
imagePickerError: 'An error occurred while selecting image',
...
contactSupportMessage: 'You can contact us via email',
shareAppMessage: 'Share the app with your friends',
rateAppMessage: 'Help us by rating us in the store',
preferences: 'Preferences',
showTransliteration: 'Show Transliteration',
showTranslation: 'Show Translation',
accountInfo: 'Account Information',
accountCreationError: 'An error occurred while creating account',
emailAlreadyInUse: 'This email is already in use',
weakPassword: 'Password is weak, please choose a stronger password',
