...
export const ar: TranslationKeys = {
  ...
  privacyInfoNoTracking: 'لا تتبع من جهات خارجية: لا نستخدم خدمات تحليلات أو تتبع من جهات خارجية.',
  ...
  privacySharingText: 'لا نبيع أو نتاجر أو نشارك بياناتك مع أي جهات خارجية. ممارسة الذكر خاصة بك وتبقى خصوصية لك.',
