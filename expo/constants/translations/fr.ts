...
export const fr: TranslationKeys = {
  ...
  sendTestNotificationDescription: 'Prévisualiser la notification réelle sur votre appareil',
  notificationsDisabledTitle: 'Notifications désactivées',
  notificationsDisabledMessage: 'Activez d’abord les notifications pour envoyer une notification test.',
  preview: 'Aperçu',
  backgroundThemes: 'Fonds d\'écran',
  ...
  freshTeal: 'Bleu sarcelle frais',
  gentleRose: 'Rose délicat',
  warmSunset: 'Coucher de soleil chaud',
  coolOcean: 'Océan frais',
  deepNight: 'Nuit profonde',
  customImage: 'Image personnalisée',
  chooseFromGallery: 'Choisir dans la galerie',
  galleryPickerError: 'Une erreur s\'est produite lors de la sélection de l\'image, veuillez réessayer',
  quranKareem: 'Le Noble Coran',
  ...
  quranDescription: 'Lire et écouter le Coran',
  verses: 'Versets',
  ayah: 'Ayah',
  ayahNumber: 'Numéro de Ayah',
  loadingVerses: 'Chargement des versets...',
  errorLoadingVerses: 'Erreur lors du chargement des versets',
  noVersesAvailable: 'Aucun verset disponible',
  bismillah: 'Au nom d\'Allah, le Tout Miséricordieux',
  meccan: 'Mecquoise',
  medinan: 'Médinoise',
  reciteSurah: 'Réciter la sourate',
  stopRecitation: 'Arrêter la récitation',
  selectReciterTitle: 'Sélectionner le récitateur',
  juzNumber: 'Juz',
  page: 'Page',
  hizbNumber: 'Hizb',
  ayahs: 'ayahs',
  ...
  distanceToKaaba: 'Distance vers la Kaaba',
  kaaba: 'Sainte Kaaba',
  facingQibla: 'Face à la Qibla',
  alignToQibla: 'Alignez votre téléphone avec la flèche',
  compassAccuracy: 'Précision de la boussole',
  accuracyLow: 'Faible',
  accuracyMedium: 'Bon',
  accuracyHigh: 'Excellent',
  accuracyUnavailable: 'Indisponible',
  calibrateCompass: 'Calibrer la boussole',
  calibrateCompassInstruction: 'Déplacez votre téléphone en forme de 8 pour calibrer la boussole',
  calibrateCompassTitle: 'La boussole a besoin d\'étalonnage',
  calibrateStep1: 'Tenez votre téléphone à la verticale et loin des objets métalliques',
  calibrateStep2: 'Déplacez-le avec un mouvement lent en forme de 8',
  calibrateStep3: 'Répétez jusqu\'à amélioration de la précision',
  ...
  locationPermissionDenied: 'Permission de localisation refusée. Activez-la dans les paramètres pour trouver la direction de la Qibla.',
  compassUnavailable: 'Boussole non disponible sur cet appareil',
  enableLocation: 'Activer la localisation',
  findingQibla: 'Recherche de la direction de la Qibla...',
  qiblaInfoTitle: 'Vertu de faire face à la Qibla',
  qiblaInfoText: 'Faire face à la Qibla est une condition de validité de la prière. C\'est la direction vers laquelle les musulmans se tournent vers la Maison Sacrée d\'Allah à La Mecque.',
  ...
  prayerTimesError: 'Impossible de charger les heures de prière',
  // ── Personnalisation du compas ──
  compassStyle: 'Style du compas',
  compassAppearance: 'Apparence du compas',
  dialStyle: 'Style du cadran',
  arrowColor: 'Couleur de la flèche',
  compassThemeClassic: 'Classique',
  compassThemeMosaic: 'Mosaïque',
  compassThemeOttoman: 'Ottoman',
  compassThemeMoroccan: 'Marocain',
  compassThemeMinimal: 'Minimaliste',
  compassThemePersian: 'Perse',
  arrowGold: 'Or',
  arrowEmerald: 'Émeraude',
  arrowCrimson: 'Cramoisi',
  arrowTurquoise: 'Turquoise',
  arrowSilver: 'Argent',
  arrowIndigo: 'Indigo',
  selectCompassStyle: 'Sélectionner le style du compas',
  compassStyleDescription: "Choisissez un style visuel islamique pour votre boussole Qibla",
firebaseNotConfigured: 'Le service de connexion est actuellement indisponible',
firebaseNotConfiguredShort: 'Le service Firebase n\'est pas configuré',
...
networkError: 'Impossible de se connecter à Internet, vérifiez votre connexion',
...
resetEmailSent: 'Le lien de réinitialisation a été envoyé à votre e-mail',
resetRequestError: 'Une erreur s\'est produite lors de l\'envoi du lien',
emailMayBeRegistered: 'Cet e-mail n\'est pas enregistré, veuillez vérifier',
tooManyResetRequests: 'Trop de demandes de réinitialisation, veuillez patienter',
returnToSignIn: 'Retour à la connexion',
checkEmailForResetLink: 'Vérifiez votre e-mail pour le lien de réinitialisation',
verificationEmailSentTo: 'Lien de vérification envoyé à {{email}}',
verificationPending: 'E-mail non vérifié, veuillez vérifier votre boîte mail',
verificationEmailResent: 'Lien de vérification renvoyé avec succès',
clickVerificationLink: 'Cliquez sur le lien de vérification dans votre e-mail',
verifyEmailTitle: 'Vérifiez votre e-mail',
resendVerification: 'Renvoyer le lien de vérification',
resendingVerification: 'Renvoyé...',
checkingVerification: 'Vérification...',
verificationComplete: 'Vérifié, continuez maintenant',
emailVerified: 'E-mail vérifié',
logoutConfirm: 'Êtes-vous sûr de vouloir vous déconnecter ?',
logoutError: 'Une erreur s\'est produite lors de la déconnexion',
updateProfileError: 'Une erreur s\'est produite lors de la mise à jour du profil',
updatePasswordError: 'Une erreur s\'est produite lors de la mise à jour du mot de passe',
...
photoUploadedSuccessfully: 'Photo téléchargée avec succès',
photoUploadError: 'Une erreur s\'est produite lors du téléchargement',
photoRemovedSuccessfully: 'Photo supprimée avec succès',
photoRemoveError: 'Une erreur s\'est produite lors de la suppression',
removePhoto: 'Supprimer la photo',
removePhotoConfirm: 'Êtes-vous sûr de vouloir supprimer cette photo ?',
changeProfilePhoto: 'Changer la photo de profil',
takePhoto: 'Prendre une photo',
cameraPermissionDenied: 'Autorisation de la caméra refusée',
imagePickerError: 'Une erreur s\'est produite lors de la sélection',
cameraError: 'Une erreur s\'est produite lors de la prise de photo',
...
contactSupportMessage: 'Vous pouvez nous contacter par e-mail',
shareAppMessage: 'Partagez l\'app avec vos amis',
rateAppMessage: 'Aidez-nous en nous évaluant dans le magasin',
preferences: 'Préférences',
showTransliteration: 'Afficher la translittération',
showTranslation: 'Afficher la traduction',
accountInfo: 'Informations du compte',
accountCreationError: 'Une erreur s\'est produite lors de la création du compte',
emailAlreadyInUse: 'Cet e-mail est déjà utilisé',
weakPassword: 'Le mot de passe est faible, veuillez en choisir un plus fort',
