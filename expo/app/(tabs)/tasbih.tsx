...
const styles = StyleSheet.create({
  ...
  mainArabicText: { fontSize: 18, fontWeight: '700' as const, color: DEEP_GREEN, textAlign: 'center', marginBottom: 2, lineHeight: 28, paddingHorizontal: 8, alignSelf: 'stretch', writingDirection: 'rtl' as const },
